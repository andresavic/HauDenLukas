...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(App, [{
    ...
    value: function d() {
      ...
      this.end = Bodies.rectangle(400, 0, 100, 20, {
        label: "bell",
        isStatic: true
      });
      ...
      Events.on(engine, 'afterUpdate', function (event) {
        ...
        if (_this3.highestPointArrived === false && _this3.frosch.position.y > _this3.highestPoint) {
          ...
          console.log("HIGHET POINT", _this3.highestPoint - 10);
          matter_js__WEBPACK_IMPORTED_MODULE_8___default.a.World.addBody(engine.world, Bodies.rectangle(400, _this3.highestPoint - 10, 200, 2, {
            isStatic: true,
            isSensor: true
          }));
        } else {
...
//# sourceMappingURL=index.js.03ba67bce621b2d7f5c2.hot-update.js.map