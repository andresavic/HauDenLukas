...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(App, [{
    ...
    value: function d() {
      ...
      this.frosch = Bodies.rectangle(20, 600, 20, 20);
      this.frosch.restitution = 0.8;
      var ground = Bodies.rectangle(20, 610, 810, 60, {
        isStatic: true
      });
      World.add(engine.world, [this.frosch, ground]); // run the engine
...
//# sourceMappingURL=index.js.5e538254c7f29ae0a8fb.hot-update.js.map