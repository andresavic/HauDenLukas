...
/* harmony import */ var matter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! matter-js */ "matter-js");
...
class App extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  shot() {
    ...
    matter_js__WEBPACK_IMPORTED_MODULE_1___default.a.Body.setMass(this.frosch, 1);
    matter_js__WEBPACK_IMPORTED_MODULE_1___default.a.Body.applyForce(this.frosch, this.frosch.position, {
      x: 0,
      y: -0.09
    });
  }
  ...
  d() {
    var Engine = matter_js__WEBPACK_IMPORTED_MODULE_1___default.a.Engine,
        ...
        Events = matter_js__WEBPACK_IMPORTED_MODULE_1___default.a.Events,
    ...
    Events.on(engine, 'afterUpdate', event => {
      ...
      if (this.highestPointArrived === false && this.frosch.position.y > this.highestPoint) {
        ...
        matter_js__WEBPACK_IMPORTED_MODULE_1___default.a.World.addBody(engine.world, Bodies.rectangle(400, m, 200, 2, {
          isStatic: true,
          isSensor: true
        }));
      } else {
...
module.exports = __webpack_require__(/*! /Users/andresavic/Code/Privat/HauDenLukas/pages/index.js */"./pages/index.js");
